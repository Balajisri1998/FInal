...
<h1 style="text-align: center;" id="nav1">ADMIN LOGIN</h1>
<script>
  $(function(){
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6" style="background: #e6e6e6;text-align: left;padding-left: 15px;border-radius: 10px 10px 10px 10px; -moz-border-radius: 10px 10px 10px 10px; -webkit-border-radius: 10px 10px 10px 10px; border: 0px solid #000000;">
    	<form action="admincheck.php" method="POST">
    		Admin ID<br>
    		<input type="text" name="adminid" placeholder=" Enter Your ID" style="border-radius: 4px 4px 4px 4px;border-width: 0PX 0PX 0PX 4PX;"><br><br>
    		Password<br>
    		<input type="Password" name="adminpassword" placeholder=" Enter Password" style="border-radius: 4px 4px 4px 4px;border-width: 0PX 0PX 0PX 4PX;"></input><br><br>
    		<input type="submit" value="login"style="border-radius: 4px 4px 4px 4px;">
